    ...
    <section id="hero" className="bg-[#1E1B22] pt-40 pb-24 relative overflow-hidden">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="max-w-4xl mx-auto text-[#8F7FA8] text-lg leading-relaxed mb-12">
          RepUpRise is an AI-powered reputation intelligence and management platform that enables organizations to monitor digital conversations, understand public perception, detect early crisis signals, and respond with structured strategic action[cite: 105].
        </p>

        <div className="flex justify-center gap-6">
          <button className="bg-[#5B3E7A] text-white px-8 py-4 rounded font-black uppercase tracking-widest hover:bg-[#3F2A54] transition-all">
            Request Access
          </button>
          <button className="border border-[#3F2A54] text-[#E6E4EA] px-8 py-4 rounded font-black uppercase tracking-widest hover:bg-[#3F2A54] transition-all">
            Book a Demo
          </button>
        </div>
      </div>
